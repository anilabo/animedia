...
const UserWillWatchAllAnimesComponent = ({ user }: InitialProps) => (
  <div className="max-w-6xl m-2 md:mx-auto mb-10">
    <div className="grid md:grid-cols-3 gap-4 text-gray-600 ">
      ...
      <div className="md:col-span-2 flex flex-col gap-4">
        <AnimeList
          animes={user.will_watch_animes}
          progress="will_watch"
          limit={user.will_watch_animes.length}
          user={user} />
      </div>
    </div>
  </div>
...
export default UserWillWatchAllAnimesComponent;
